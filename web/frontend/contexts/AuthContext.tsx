...
interface AuthContextType {
    ...
    register: (data: { email: string; password: string; full_name?: string; role: 'student' | 'lecturer'; student_id?: string }) => Promise<void>;
    logout: () => void;
...
export function AuthProvider({ children }: AuthProviderProps) {
    ...
    const register = async (data: { email: string; password: string; full_name?: string; role: 'student' | 'lecturer'; student_id?: string }) => {
        try {
            setLoading(true);
